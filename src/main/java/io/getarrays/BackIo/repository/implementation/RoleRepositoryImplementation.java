...
import io.getarrays.BackIo.rowmapper.RoleRowMapper;
...
import static io.getarrays.BackIo.query.RoleQuery.*;
import static io.getarrays.BackIo.enumeration.RoleType.ROLE_USER;
import static io.getarrays.BackIo.query.UserQuery.UPDATE_USER_ROLE_BY_ID;
